# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-10-14 16:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('Clean-up', 'Clean up'), ('Combat', 'Combat')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Crisis',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('Clean-up', 'Clean up'), ('Ongoing', 'Ongoing'), ('Resolved', 'Resolved')], max_length=20)),
