# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-10-29 12:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('planNumber', models.IntegerField(editable=False, validators=[django.core.validators.MinValueValidator(1)])),
                ('description', models.TextField(blank=True, null=True)),
                ('status', models.CharField(choices=[('Planning', 'Planning'), ('CORequest', 'Awaiting CO Approval'), ('PMORequest', 'Awaiting PMO Approval'), ('Rejected', 'Rejected'), ('PMOApproved', 'Approved')], max_length=20)),
                ('resolutionTime', models.DurationField()),
                ('projectedCasualties', models.IntegerField(validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('Cleanup', 'Clean up'), ('Ongoing', 'Ongoing'), ('Resolved', 'Resolved')], max_length=20)),
